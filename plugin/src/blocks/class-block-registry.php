...
final class BlockRegistry {
	...
	public static function register_blocks(): void {
		...
		foreach ( array( 'restaurante-menu', 'restaurante-pizza-builder', 'restaurante-cart', 'restaurante-checkout', 'restaurante-order-status', 'restaurante-reservations', 'restaurante-saved-pizzas', 'restaurante-delivery-coverage', 'restaurante-header-actions' ) as $block ) {
