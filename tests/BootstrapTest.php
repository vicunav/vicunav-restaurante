...
final class BootstrapTest extends TestCase {
	...
	public function test_defines_foundational_constants(): void {
		$this->assertSame( '0.17.0', VICU_RESTAURANTE_VERSION );
	...
	public function test_bootstrap_guards_and_publishes_contract_once(): void {
		...
		$this->assertArrayHasKey( 'init', $vicu_restaurante_test_actions );
	}
	...
	public function test_plugin_header_declares_requirements(): void {
		...
		$this->assertStringContainsString( 'Version:           0.17.0', $contents );
	...
	public function test_public_contract_documents_implementation_state(): void {
		...
		$this->assertStringContainsString( '| Pizzas guardadas | REST-02L | Implementado |', $contract );
		$this->assertStringContainsString( '| Bloque de menú y filtros | REST-02M | Implementado |', $contract );
		$this->assertStringContainsString( '| Bloque de reservas | REST-02P | Implementado |', $contract );
		$this->assertStringContainsString( '| Bloque de pizzas guardadas | REST-02Q | Implementado |', $contract );
